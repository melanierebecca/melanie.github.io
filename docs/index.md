...
- **Development Practices:** Agile methodologies, Team Leading, Code reviews, API design and integration, Reusable module design
- **Blockchain and Cryptocurrency:** Cryptocurrency, Crypto Wallet Interactions
- **Payment Systems:** Factory Strategy Implementation for Card/Wallet Payments
